#!/bin/bash
#SBATCH --job-name=k9-568
#SBATCH --nodes=1
#SBATCH --gres=gpu:a100:2
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=16
#SBATCH --time=8:00:00
#SBATCH --output=/home/hpc/v100dd/v100dd12/code/3D-Mem/slurm/qwen/hierarchy/kmeans_9/k9-568-%j.out
...
CUDA_VISIBLE_DEVICES=1 python /home/hpc/v100dd/v100dd12/code/3D-Mem/run_aeqa_evaluation_qwen.py \
  -cf /home/hpc/v100dd/v100dd12/code/3D-Mem/script/layer2_mode/kmeans_9/qwen_568.yaml \
  --hierarchy_mode True \
  --layer2_num 3 \
  --chat_seed 568
