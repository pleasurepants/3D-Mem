#!/bin/bash
#SBATCH --job-name=k18-32
#SBATCH --nodes=1
#SBATCH --gres=gpu:a100:2
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=16
#SBATCH --time=12:00:00
#SBATCH --output=/home/hpc/v100dd/v100dd12/code/3D-Mem/slurm/qwen/hierarchy/kmeans_18/k18-32-%j.out
...
CUDA_VISIBLE_DEVICES=1 python /home/hpc/v100dd/v100dd12/code/3D-Mem/run_aeqa_evaluation_qwen.py \
  -cf /home/hpc/v100dd/v100dd12/code/3D-Mem/script/layer2_mode/kmeans_18/qwen_32.yaml \
  --hierarchy_mode True \
  --layer2_num 6 \
  --chat_seed 32
