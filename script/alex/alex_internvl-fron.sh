...
# srun --nodes=1 --gres=gpu:a100:2 --ntasks=1 --cpus-per-task=1225 --time=4:00:00 --partition a100 --pty bash
# srun --nodes=1 --gres=gpu:a40:2 --ntasks=1 --cpus-per-task=1225 --time=4:00:00 --partition a40 --pty bash
...
# vllm serve /anvme/workspace/v100dd12-3dmem/model/MiniCPM-V-2_225 \
