...
CUDA_VISIBLE_DEVICES=1 python /home/hpc/v100dd/v100dd12/code/3D-Mem/chunk_to_traj_caption.py \
  --exp_tuple /anvme/workspace/v100dd12-3dmem/openeqa/pipeline_2/training_set/exp_tuple_v0.json \
  --max_steps 10 \
  --seed 32 \
  --out /anvme/workspace/v100dd12-3dmem/openeqa/pipeline_2/training_set/final_captions_from_chunck.json
