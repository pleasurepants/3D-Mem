...
# srun --nodes=1 --gres=gpu:a100:2 --ntasks=1 --cpus-per-task=16 --time=0:30:00 --partition a100 --pty bash
...
CUDA_VISIBLE_DEVICES=1 python -m debugpy --listen 0.0.0.0:8798 --wait-for-client /home/hpc/v100dd/v100dd12/code/3D-Mem/run_aeqa_evaluation_qwen.py \
    -cf /home/hpc/v100dd/v100dd12/code/3D-Mem/cfg/alex/qwen-debug.yaml \
    --hierarchy_mode True \
    --layer2_num 4 \
    --chat_seed 42
