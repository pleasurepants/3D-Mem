#!/bin/bash
#SBATCH --job-name=q-rand-top3-568
#SBATCH --nodes=1
#SBATCH --gres=gpu:a40:2
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=16
#SBATCH --time=24:00:00 
#SBATCH --output=/home/hpc/v100dd/v100dd12/code/3D-Mem/slurm/experience/qwen-rand-top3-568-%j.out
...
if [ -z "$SLURM_JOB_GPUS" ]; then export CUDA_VISIBLE_DEVICES=0,1; else export CUDA_VISIBLE_DEVICES=$SLURM_JOB_GPUS; fi
...
CUDA_VISIBLE_DEVICES=1 python /home/hpc/v100dd/v100dd12/code/3D-Mem/run_aeqa_evaluation_qwen.py \
    -cf /home/hpc/v100dd/v100dd12/code/3D-Mem/cfg/alex_cfg/qwen_runs/qwen-random-top3-seed568.yaml \
    --replay_mode random \
    --replay_top 3 \
