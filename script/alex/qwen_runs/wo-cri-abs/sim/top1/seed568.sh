#!/bin/bash
#SBATCH --job-name=wo-cri-abs-sim-top1-seed568
#SBATCH --nodes=1
#SBATCH --gres=gpu:a40:2
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=16
#SBATCH --time=24:00:00 
#SBATCH --output=/home/hpc/v100dd/v100dd12/code/3D-Mem/slurm/qwen/wo-cri-abs/sim/top1/seed568-%j.out
