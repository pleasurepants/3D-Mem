#!/bin/bash
#SBATCH --job-name=hr-k6-s568
#SBATCH --nodes=1
#SBATCH --gres=gpu:a40:2
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=16
#SBATCH --time=9:00:00 
#SBATCH --output=/home/hpc/v100dd/v100dd12/code/3D-Mem/slurm/ablation/hierarchy/kmeans6/hr-k6-s568-%j.out 
...
CUDA_VISIBLE_DEVICES=1 python /home/hpc/v100dd/v100dd12/code/3D-Mem/run_aeqa_evaluation_qwen.py \
    -cf /home/hpc/v100dd/v100dd12/code/3D-Mem/cfg/ablation/hierarchy/kmeans6/hierarchy_k6_s568.yaml \
    --base_mode hierarchy \
    --kmeans 6 \
    --episodic_context \
    --chat_seed 568
