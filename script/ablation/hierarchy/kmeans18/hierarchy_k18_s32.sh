#!/bin/bash
#SBATCH --job-name=hr-k18-s32
#SBATCH --nodes=1
#SBATCH --gres=gpu:a40:2
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=16
#SBATCH --time=9:00:00 
#SBATCH --output=/home/hpc/v100dd/v100dd12/code/3D-Mem/slurm/ablation/hierarchy/kmeans18/hr-k18-s32-%j.out 
...
CUDA_VISIBLE_DEVICES=1 python /home/hpc/v100dd/v100dd12/code/3D-Mem/run_aeqa_evaluation_qwen.py \
    -cf /home/hpc/v100dd/v100dd12/code/3D-Mem/cfg/ablation/hierarchy/kmeans18/hierarchy_k18_s32.yaml \
    --base_mode hierarchy \
    --kmeans 18 \
    --episodic_context \
    --chat_seed 32
