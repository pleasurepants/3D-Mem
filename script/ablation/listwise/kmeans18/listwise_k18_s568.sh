#!/bin/bash
#SBATCH --job-name=lw-k18-s568
#SBATCH --nodes=1
#SBATCH --gres=gpu:a40:2
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=16
#SBATCH --time=9:00:00 
#SBATCH --output=/home/hpc/v100dd/v100dd12/code/3D-Mem/slurm/ablation/listwise/kmeans18/lw-k18-s568-%j.out 
...
CUDA_VISIBLE_DEVICES=1 python /home/hpc/v100dd/v100dd12/code/3D-Mem/run_aeqa_evaluation_qwen.py \
    -cf /home/hpc/v100dd/v100dd12/code/3D-Mem/cfg/ablation/listwise/kmeans18/listwise_k18_s568.yaml \
    --base_mode listwise \
    --kmeans 18 \
    --episodic_context \
    --chat_seed 568
