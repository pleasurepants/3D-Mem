#!/bin/bash
#SBATCH --job-name=cvf-cca-r-1-32
#SBATCH --nodes=1
#SBATCH --gres=gpu:a100:2
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=16
#SBATCH --time=12:00:00
#SBATCH --output=/home/hpc/v100dd/v100dd12/code/3D-Mem/slurm/exp_at/cvf/caption-critique-abstraction/random/top-1/cvf-cca-r-1-32-%j.out
...
CUDA_VISIBLE_DEVICES=1 python /home/hpc/v100dd/v100dd12/code/3D-Mem/run_aeqa_evaluation_qwen.py \
  -cf /home/hpc/v100dd/v100dd12/code/3D-Mem/cfg/exp_at/cvf/caption-critique-abstraction/random/top-1/cvf-cca-r-1-32.yaml \
  --replay_mode random \
  --replay_top 1 \
