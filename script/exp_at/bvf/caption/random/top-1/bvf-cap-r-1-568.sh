#!/bin/bash
#SBATCH --job-name=bvf-cap-r-1-568
#SBATCH --nodes=1
#SBATCH --gres=gpu:a100:2
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=16
#SBATCH --time=12:00:00
#SBATCH --output=/home/hpc/v100dd/v100dd12/code/3D-Mem/slurm/exp_at/bvf/caption/random/top-1/bvf-cap-r-1-568-%j.out
...
CUDA_VISIBLE_DEVICES=1 python /home/hpc/v100dd/v100dd12/code/3D-Mem/run_aeqa_evaluation_qwen.py \
  -cf /home/hpc/v100dd/v100dd12/code/3D-Mem/cfg/exp_at/bvf/caption/random/top-1/bvf-cap-r-1-568.yaml \
  --replay_mode random \
  --replay_top 1 \
