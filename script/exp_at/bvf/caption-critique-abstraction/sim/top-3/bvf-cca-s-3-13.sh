#!/bin/bash
#SBATCH --job-name=bvf-cca-s-3-13
#SBATCH --nodes=1
#SBATCH --gres=gpu:a100:2
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=16
#SBATCH --time=12:00:00
#SBATCH --output=/home/hpc/v100dd/v100dd12/code/3D-Mem/slurm/exp_at/bvf/caption-critique-abstraction/sim/top-3/bvf-cca-s-3-13-%j.out
...
CUDA_VISIBLE_DEVICES=1 python /home/hpc/v100dd/v100dd12/code/3D-Mem/run_aeqa_evaluation_qwen.py \
  -cf /home/hpc/v100dd/v100dd12/code/3D-Mem/cfg/exp_at/bvf/caption-critique-abstraction/sim/top-3/bvf-cca-s-3-13.yaml \
  --replay_mode sim \
  --replay_top 3 \
