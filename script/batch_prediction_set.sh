#!/bin/bash
#SBATCH --job-name=pd-0.7-184
#SBATCH --nodes=1
#SBATCH --gres=gpu:1
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=16
#SBATCH --time=10-00:00:00
#SBATCH --exclude=worker-minor-1,worker-minor-3,worker-minor-4,worker-minor-5,worker-minor-6,worker-3,worker-4,worker-5
#SBATCH --output=/home/wiss/zhang/code/openeqa/3D-Mem/slurm/4o/0.7-184-pred-%j.out 
