#!/bin/bash
#SBATCH --job-name=kt-novf-41
#SBATCH --nodes=1
#SBATCH --gres=gpu:1
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=16
#SBATCH --time=10-00:00:00
#SBATCH --exclude=worker-minor-1,worker-minor-3,worker-minor-4,worker-minor-5,worker-minor-6,worker-1,worker-3,worker-4,worker-5,worker-8,worker-9
#SBATCH --output=/home/wiss/zhang/code/openeqa/3D-Mem/slurm/kt/kt-novf-41-%j.out 
