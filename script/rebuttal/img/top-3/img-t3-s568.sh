#!/bin/bash
#SBATCH --job-name=img-t3-s568
#SBATCH --nodes=1
#SBATCH --gres=gpu:a40:2
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=16
#SBATCH --time=12:00:00 
#SBATCH --output=/home/hpc/v100dd/v100dd12/code/3D-Mem/slurm/rebuttal/img/img-t3-s568-%j.out
...
CUDA_VISIBLE_DEVICES=0 PYTORCH_CUDA_ALLOC_CONF=expandable_segments:True \
    vllm serve /anvme/workspace/v100dd12-3dmem_rebuttal/v100dd12-3dmem-1769055061/model/Qwen2.5-VL-7B-Instruct \
...
CUDA_VISIBLE_DEVICES=1 python /home/hpc/v100dd/v100dd12/code/3D-Mem/run_aeqa_evaluation_qwen.py \
    -cf /home/hpc/v100dd/v100dd12/code/3D-Mem/cfg/rebuttal/img/top-3/s568.yaml \
    --replay_mode img \
    --replay_top 3 \
    --retrieve_root /anvme/workspace/v100dd12-3dmem_rebuttal/v100dd12-3dmem-1769055061/openeqa/pipeline_2/training_set \
    --chat_seed 568 \
    --traj_file /anvme/workspace/v100dd12-3dmem_rebuttal/v100dd12-3dmem-1769055061/openeqa/pipeline_2/training_set/captions_reflection_abstraction_v1.json \
    --caption true \
    --critique true \
    --abstraction true \
    --exp_tuple /anvme/workspace/v100dd12-3dmem_rebuttal/v100dd12-3dmem-1769055061/openeqa/pipeline_2/training_set/exp_tuple_v0.json
