#!/bin/bash
#SBATCH --job-name=c-r-3-568
#SBATCH --nodes=1
#SBATCH --gres=gpu:a40:2
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=16
#SBATCH --time=24:00:00 
#SBATCH --output=/home/hpc/v100dd/v100dd12/code/3D-Mem/slurm/experience/caption/random/top-3/c-r-3-568-%j.out
...
CUDA_VISIBLE_DEVICES=1 python /home/hpc/v100dd/v100dd12/code/3D-Mem/run_aeqa_evaluation_qwen.py -cf /home/hpc/v100dd/v100dd12/code/3D-Mem/cfg/experience/caption/random/top-3/c-r-3-568.yaml --replay_mode random --replay_top 3 --retrieve_root /anvme/workspace/v100dd12-3dmem/openeqa/ee_qwen/qwen-exp-168 --exp_tuple /anvme/workspace/v100dd12-3dmem/openeqa/ee_qwen/qwen-exp-168/exp_tuple_v0.json --chat_seed 568 --caption true --critique false --abstraction false
