#!/bin/bash
#SBATCH --job-name=ct-r-1-13
#SBATCH --nodes=1
#SBATCH --gres=gpu:a40:2
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=16
#SBATCH --time=10:00:00 
#SBATCH --output=/home/hpc/v100dd/v100dd12/code/3D-Mem/slurm/experience/caption-trajectory_experience/traj_random/top-1/ct-r-1-13-%j.out
...
CUDA_VISIBLE_DEVICES=1 python /home/hpc/v100dd/v100dd12/code/3D-Mem/run_aeqa_evaluation_qwen.py -cf /home/hpc/v100dd/v100dd12/code/3D-Mem/cfg/experience/caption-trajectory_experience/traj_random/top-1/ct-r-1-13.yaml --replay_mode traj_random --replay_top 1 --retrieve_root /anvme/workspace/v100dd12-3dmem/openeqa/ee_qwen/qwen-exp-168 --chat_seed 13 --traj_file /anvme/workspace/v100dd12-3dmem/openeqa/ee_qwen/qwen-exp-168/traj_abs_single.json --caption true --critique true --abstraction true --exp_tuple /anvme/workspace/v100dd12-3dmem/openeqa/ee_qwen/qwen-exp-168/exp_tuple_v0.json
