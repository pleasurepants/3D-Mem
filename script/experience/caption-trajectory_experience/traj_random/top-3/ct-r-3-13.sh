#!/bin/bash
#SBATCH --job-name=ct-r-3-13
#SBATCH --nodes=1
#SBATCH --gres=gpu:a100:2
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=16
#SBATCH --time=12:00:00 
#SBATCH --output=/home/hpc/v100dd/v100dd12/code/3D-Mem/slurm/experience/caption-trajectory_experience/traj_random/top-3/ct-r-3-13-%j.out
