#!/bin/bash
#SBATCH --job-name=lb-s-t1-s568
#SBATCH --nodes=1
#SBATCH --gres=gpu:a40:2
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=16
#SBATCH --time=14:00:00 
#SBATCH --output=/home/hpc/v100dd/v100dd12/code/3D-Mem/slurm/experience/format_unformat/lessons_format/both/sim/top-1/lessons-both-sim-t1-s568-%j.out
...
CUDA_VISIBLE_DEVICES=1 python /home/hpc/v100dd/v100dd12/code/3D-Mem/run_aeqa_evaluation_qwen.py \
    -cf /home/hpc/v100dd/v100dd12/code/3D-Mem/cfg/experience/format_unformat/lessons_format/both/sim/top-1/lessons-both-sim-t1-s568.yaml \
