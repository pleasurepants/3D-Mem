#!/bin/bash
#SBATCH --job-name=ug-s-t3-s32
#SBATCH --nodes=1
#SBATCH --gres=gpu:a40:1
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=16
#SBATCH --time=14:00:00 
#SBATCH --output=/home/hpc/v100dd/v100dd12/code/3D-Mem/slurm/experience/format_unformat/unformat/gpt/sim/top-3/unformat-all-sim-t3-s32-%j.out
...
python /home/hpc/v100dd/v100dd12/code/3D-Mem/run_aeqa_evaluation_gpt.py \
    -cf /home/hpc/v100dd/v100dd12/code/3D-Mem/script/experience/format_unformat/unformat/gpt/sim/top-3/unformat-all-sim-t3-s32.yaml \
