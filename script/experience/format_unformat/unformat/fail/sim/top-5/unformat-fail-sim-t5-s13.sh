#!/bin/bash
#SBATCH --job-name=uf-s-t5-s13
#SBATCH --nodes=1
#SBATCH --gres=gpu:a40:2
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=16
#SBATCH --time=14:00:00 
#SBATCH --output=/home/hpc/v100dd/v100dd12/code/3D-Mem/slurm/experience/format_unformat/unformat/fail/sim/top-5/unformat-fail-sim-t5-s13-%j.out
...
CUDA_VISIBLE_DEVICES=1 python /home/hpc/v100dd/v100dd12/code/3D-Mem/run_aeqa_evaluation_qwen.py \
    -cf /home/hpc/v100dd/v100dd12/code/3D-Mem/cfg/experience/format_unformat/unformat/fail/sim/top-5/unformat-fail-sim-t5-s13.yaml \
