#!/bin/bash
#SBATCH --job-name=ca-s-3-32
#SBATCH --nodes=1
#SBATCH --gres=gpu:a100:2
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=16
#SBATCH --time=15:00:00 
#SBATCH --output=/home/hpc/v100dd/v100dd12/code/3D-Mem/slurm/experience/caption-abstraction/sim/top-3/ca-s-3-32-%j.out
...
CUDA_VISIBLE_DEVICES=1 python /home/hpc/v100dd/v100dd12/code/3D-Mem/run_aeqa_evaluation_qwen.py -cf /home/hpc/v100dd/v100dd12/code/3D-Mem/cfg/experience/caption-abstraction/sim/top-3/ca-s-3-32.yaml --replay_mode sim --replay_top 3 --retrieve_root /anvme/workspace/v100dd12-3dmem/openeqa/ee_qwen/qwen-exp-168 --chat_seed 32 --caption true --critique false --abstraction true     --exp_tuple /anvme/workspace/v100dd12-3dmem/openeqa/ee_qwen/qwen-exp-168/exp_tuple_v0.json
