#!/bin/bash
#SBATCH --job-name=llm-top5-low-568
#SBATCH --nodes=1
#SBATCH --gres=gpu:a40:1
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=16
#SBATCH --time=16:00:00
#SBATCH --output=/home/hpc/v100dd/v100dd12/code/3D-Mem/slurm/gpt/llm_score/top5-low-seed_568-%j.out
...
python /home/hpc/v100dd/v100dd12/code/3D-Mem/run_aeqa_evaluation_gpt.py \
    -cf /home/hpc/v100dd/v100dd12/code/3D-Mem/script/ppl/top5/low/config_568.yaml \
