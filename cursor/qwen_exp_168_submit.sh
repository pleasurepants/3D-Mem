#!/bin/bash
# Submit qwen-exp-168 run (top_k=0 env recall disabled) using A40x2 24h
set -eo pipefail

ROOT=/home/hpc/v100dd/v100dd12/code/3D-Mem
YAML=${ROOT}/cursor/qwen_exp_168.yaml
SLURM_OUT=${ROOT}/slurm/ee/qwen-exp-168-%j.out
...
# Run evaluation (GPU 1) with top_k=0 (replay disabled)
