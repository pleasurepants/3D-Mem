#!/bin/bash
# Submit Qwen runs for four seeds (each sbatch uses 2 GPUs; local vLLM per job) [pairwise]

set -euo pipefail

ROOT=/home/wiss/zhang/code/openeqa/3D-Mem
CURSOR_DIR=${ROOT}/cursor
SLURM_OUT=${ROOT}/slurm/qwen/pairwise
...
#SBATCH --output=/home/wiss/zhang/code/openeqa/3D-Mem/slurm/qwen/pairwise/pairwise-${SEED}-%j.out
