...
INPUT_PATH = Path(
    "./slurm/experience/format_unformat/unformat/gpt/sim/top-5/unformat-all-sim-t5-s568-3141243.out"
)
QUESTIONS_PATH = Path("./data/aeqa_questions-41.json")
OUTPUT_PATH = Path("./teaser/reexplore.json")
